...
public class programa_processing extends PApplet {
...
public void setup() {
  ...
  seta_colorida_1 = new Button_2("", 140, 340, 26.6667f, 80, 0, 0, 360, 0);
  seta_colorida_2 = new Button_2("", 166.6667f, 340, 26.6667f, 80, 360, 360, 0, 0);
  seta_colorida_3 = new Button_2("", 193.3333f, 340, 26.6667f, 80, 0, 360, 0, 0);
...
public void draw() {
  ...
  if(colorido==true){
    ...
    seta_colorida_1 = new Button_2("", 140, 340, 26.6667f, 80, 0, 0, 360, 500);
    seta_colorida_2 = new Button_2("", 166.6667f, 340, 26.6667f, 80, 360, 360, 0, 500);
    seta_colorida_3 = new Button_2("", 193.3333f, 340, 26.6667f, 80, 0, 360, 0, 500);
    seta_colorida_4 = new Button_2("", 260, 340, 40, 40, 0, 0, 0, 0);
    seta_colorida_5 = new Button_2("", 260, 380, 40, 40, 0, 0, 360, 0);
    seta_colorida_6 = new Button_2("", 300, 340, 40, 40, 360, 360, 0, 0);
    seta_colorida_7 = new Button_2("", 300, 380, 40, 40, 0, 360, 0, 0);
...
public void update(){
  ...
  if(colorido==true){
    ...
    cor= round(random(-0.5f,3.4999f));  //seleção de uma cor aleatória para a seta, incluindo a cor preta
  }
  else{
...
class Seta { 
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "programa_processing" };
    if (passedArgs != null) {
